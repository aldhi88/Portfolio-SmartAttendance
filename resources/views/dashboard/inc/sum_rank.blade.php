            ...
            <div class="card-body text-white p-3">
                <div class="media">
                    <div class="media-body overflow-hidden">
                        ...
                        <h2 class="mb-0">
                            <i class="fas fa-coins text-white" style="scale: 0.5"></i>
                            <span id="rank1-point" class="text-white">-</span>
                        </h2>
                        <h5 class="my-0 text-danger bg-white d-inline px-1" style="min-height: 0px;" id="rank1-name">-</h5>
                        <div class="text-rapat text-white lead" id="rank1-org">-</div>
                        <div class="text-rapat text-white lead" id="rank1-as">-</div>
                    </div>
                </div>
                <div class="position-absolute" style="top: -1px; right: 1px;">
                    <i class="fas fa-medal text-white" style="font-size: 70px;"></i>
                </div>
            </div>

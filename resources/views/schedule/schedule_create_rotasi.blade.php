<div>
    ...
    <form wire:submit.prevent="wireSubmitRotasi">
            ...
            <div class="row">
                <div class="col-12 col-md-2">
                    <div class="form-group mb-1 position-relative">
                        @if ($i > 1)
                            <i wire:click="delShift({{$i}})" class="fas fa-times text-danger position-absolute top-50 end-0 translate-middle-y me-2"
                            style="cursor: pointer"></i>
                        @endif

                        <input placeholder="Nama Shift"
                            wire:model="dtRotasi.day_work.time.{{ $i }}.name"
                ...
                <div class="col-12 col-md">
                    <div class="form-group mb-1">
                        <input placeholder="HH:mm:ss"
                            wire:model="dtRotasi.day_work.time.{{ $i }}.work_time"
        ...
        <div class="row mt-2">
            <div class="col">
                <button wire:click="addShift()" type="button" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Shift</button>
            </div>
        </div>

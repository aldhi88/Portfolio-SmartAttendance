<div>
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between row">
                ...
                <div class="col-12 col-sm text-left text-sm-right mt-2 mt-sm-0">
                    <a href="{{ route('rdp.pengajuan.izin-keluar.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus fa-fw"></i> Ajukan SIK
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <table id="myTable" class="table table-bordered table-striped" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nomor SK Keluar</th>
                                    <th class="text-center">Tanggal SK Keluar</th>
                                    <th class="text-center">Tanggal Keluar</th>
                                    <th class="text-center">Blok</th>
                                    <th class="text-center">Tipe</th>
                                    <th class="text-center">Nomor</th>
                                    <th class="text-center">Status</th>
                                    <th class="text-center">File SIK</th>
                                </tr>
                            </thead>
    ...
    @include('rdp.karyawan_keluar.atc.karyawan_data_atc')

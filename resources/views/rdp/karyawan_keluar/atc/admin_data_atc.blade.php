...
<script>
    ...
    var pengajuanPendataanAsetStatus = @json(\App\Repositories\RdpKaryawanKeluarRepo::ASSET_SUBMITTED_STATUS);
    var adminReviewableStatus = @json(\App\Repositories\RdpKaryawanKeluarRepo::ADMIN_REVIEWABLE_STATUS);
    ...
    var dtTable = $('#myTable').DataTable({
        ...
        ajax: '{{ route("rdp.keluar-rdp.izin-keluar.indexDT") }}',
        columns: [
            {
                ...
                render: function(data) {
                    ...
                    const dtJson = {
                        msg: `Apakah anda yakin menghapus izin keluar ${nama}?`,
                        id: data.id
                    };
                    ...
                    return `
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{ url('rdp/keluar-rdp/izin-keluar/detail') }}/${data.id}" class="dropdown-item">
                                    <i class="fas fa-eye fa-fw"></i> Detail Data
                                </a>
                                <a href="{{ url('rdp/keluar-rdp/izin-keluar/edit') }}/${data.id}" class="dropdown-item">
                                ...
                                ${canPendataanAset ? `<a href="{{ url('rdp/keluar-rdp/izin-keluar/pendataan-aset') }}/${data.id}" class="dropdown-item">

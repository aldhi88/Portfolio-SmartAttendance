        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between row">
                ...
                <div class="col-12 col-sm text-left text-sm-right mt-2 mt-sm-0">
                    <a href="{{ route('rdp.pengajuan.izin-penempatan.detail', $item->id) }}" class="btn btn-secondary">
                        ...
                        <tbody>
                            @foreach ($aset as $key => $itemAset)
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" wire:model="aset.{{ $key }}.satuan" class="form-control text-center @error('aset.'.$key.'.satuan') is-invalid @enderror">

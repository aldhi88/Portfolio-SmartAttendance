...
<script>
    var pendingPimpinanStatus = @json([
        \App\Repositories\RdpKaryawanMasukRepo::SPV_APPROVED_STATUS,
    ...
    var dtTable = $('#myTable').DataTable({
        ...
        ajax: '{{ route("rdp.persetujuan.izin-penempatan.indexDT") }}',
        columns: [
            {
                    ...
                    return `
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{ url('rdp/persetujuan/izin-penempatan/detail') }}/${data.id}" class="dropdown-item">
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return renderAntrian(data, type, meta, pendingPimpinanStatus);
                }
            },
            {

...
<script>
    var dtTable = $('#myTable').DataTable({
        ...
        ajax: '{{ route("rdp.master.manager-hc-region.indexDT") }}',
        columns: [
            {
            ...
            },
            {
                ...
                render: function(data) {
                    const dtJson = {
                        msg: `Apakah anda yakin menghapus data ${data.nickname}?`,
                        info: 'User login Manager HC Region terkait juga akan ikut dihapus.',
                        id: data.id
                    };
    ...
    $(document).on('click', '#btnDeleteSelected', function () {
        ...
        $('#modalConfirmDeleteMultiple')
            .find('.msg')
            .text(`Apakah anda yakin menghapus ${ids.length} data Manager HC Region yang dipilih?`);
        $('#modalConfirmDeleteMultiple')
            .find('.delete-info')
            .text('User login Manager HC Region terkait juga akan ikut dihapus.');

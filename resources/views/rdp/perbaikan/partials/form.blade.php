...
@if ($mode === 'karyawan')
    ...
    @else
        <div class="alert alert-warning">Anda belum memiliki rumah dinas aktif, sehingga belum bisa mengajukan perbaikan.</div>
    @endif
@else
...
@include('rdp.perbaikan.partials.item_form')

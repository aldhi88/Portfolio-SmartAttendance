        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between row">
                ...
                <div class="col-12 col-sm text-left text-sm-right mt-2 mt-sm-0">
                    @if ($item->status === \App\Repositories\RdpPerbaikanRepo::PROPOSAL_ASET_REGION_PENDING_STATUS)
                    ...
                    @endif
                    <a href="{{ route('rdp.aset-region.perbaikan.index') }}" class="btn btn-secondary">

<div>
                    ...
                    <div class="col-12 col-md-4">
                        <div style="position: relative;" class="form-group">
                            ...
                            <input type="text" class="form-control
                                    @error('form.data_employee_id') is-invalid @enderror
                                    @error('employee_invalid') is-invalid @enderror
                                    @error('query') is-invalid @enderror
                                "
                                placeholder="Ketik nama..." wire:model.live.debounce.400ms="query">
    ...
    @include('libur.atc.libur_izin_edit_atc')
</div>

                ...
                <td class="hc">
                    @php
                        ...
                        if(
                            ...
                            // dd($item['lembur_collection'][$tanggalLoop][0]['checkin']);
                            $start = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item['lembur_collection'][$tanggalLoop][0]['checkin']);
                            $end   = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item['lembur_collection'][$tanggalLoop][0]['checkout']);
                            if ($end->lessThan($start)) {
                                $end->addDay();
                            }
                            $diffSeconds = $start->diffInSeconds($end);

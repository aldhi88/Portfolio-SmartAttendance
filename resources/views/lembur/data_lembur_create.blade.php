        ...
        <div class="col">
            ...
            <form wire:submit.prevent="wireSubmit">
                ...
                <div class="row">
                    <div class="col-12 col-md">
                        <div style="position: relative;" class="form-group">
                            <label>Yang dikerjakan</label>
                            <input type="text" class="form-control @error('form.pekerjaan') is-invalid @enderror" placeholder="Apa yang dikerjakan..." wire:model.live.debounce.400ms="queryPekerjaan">

...
class AdminData extends Component
{
    ...
    {
        if (RdpKaryawanKeluarRepo::delete($this->deleteId)) {
    ...
    {
        if (RdpKaryawanKeluarRepo::approvePendataanAset($this->deleteId)) {
            $this->dispatch('reloadDT', data: 'dtTable');
            $this->dispatch('closeModal', id: 'modalConfirmDelete');
    ...
    public function wireRequestRevisionBerkas()
    {
        ...
        if (RdpKaryawanKeluarRepo::requestRevisionBerkasAdmin($this->deleteId, $this->catatanRevisiBerkas)) {
    ...
    {
        if (RdpKaryawanKeluarRepo::cancelByAdmin($this->deleteId)) {
            $this->dispatch('reloadDT', data: 'dtTable');
            $this->dispatch('closeModal', id: 'modalConfirmDelete');
    ...
    {
        return view('rdp.karyawan_keluar.admin_data');
    }
}

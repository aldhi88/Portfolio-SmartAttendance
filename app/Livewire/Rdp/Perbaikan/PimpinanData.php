...
class PimpinanData extends Component
{
    ...
    {
        if (RdpPerbaikanRepo::approvePimpinan($this->actionId)) {
            $this->dispatch('reloadDT', data: 'dtTable');
            $this->dispatch('closeModal', id: 'modalConfirmDelete');
            $this->dispatch('alert', data: ['type' => 'success', 'message' => 'Perbaikan berhasil disetujui.']);
            return;
        }
    ...
    {
        if (RdpPerbaikanRepo::rejectPimpinan($this->actionId)) {
            $this->dispatch('reloadDT', data: 'dtTable');
            $this->dispatch('closeModal', id: 'modalConfirmDelete');
            $this->dispatch('alert', data: ['type' => 'success', 'message' => 'Proposal perbaikan berhasil ditolak.']);
            return;
        }
    ...
    {
        return view('rdp.perbaikan.pimpinan_data');
    }
}
